...
pattern = re.compile(r"class _AcknowledgeDispensationSheetState extends State<_AcknowledgeDispensationSheet> \{.*?Salvar na minha lista'\),\s*\),\s*\],\s*\),\s*\);\s*\\}\s*\}", re.DOTALL)
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('${d.activePrinciple} ${d.strength} - d{d.dispensedQuantity} un. recebidas.'),
