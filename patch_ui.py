...
new_class = """class _AcknowledgeDispensationSheetState extends State<_AcknowledgeDispensationSheet> {
...
result = lines[:476] + new_class.splitlines() + lines[611:]

with open('lib/pages/medications_page.dart', 'w', encoding='utf-8') as f:
    f.write('\n'.join(result) + '\n')
print("Successfully patched medications_page.dart!")
