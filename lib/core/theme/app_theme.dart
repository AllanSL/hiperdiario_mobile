...
class AppTheme {
  ...
  static ThemeData buildTheme(double factor) {
    ...
    return ThemeData(
      ...
      textTheme: TextTheme(
        titleLarge: TextStyle(fontSize: baseTitleLarge, fontWeight: FontWeight.bold),
        ...
        labelLarge: TextStyle(fontSize: baseLabelLarge, fontWeight: FontWeight.w600),
      ...
      navigationBarTheme: NavigationBarThemeData(
        labelTextStyle: WidgetStatePropertyAll(
          TextStyle(fontSize: 12.0 * f),
        ),
        iconTheme: WidgetStatePropertyAll(
          IconThemeData(size: 24.0 * f),
        ),
        height: 64.0 * f,
      ),
      ...
      chipTheme: ChipThemeData(
        labelStyle: TextStyle(fontSize: 12.0 * f, fontWeight: FontWeight.w600, color: Colors.black87),
      ...
      dialogTheme: DialogThemeData(
        ...
        contentTextStyle: TextStyle(fontSize: baseBodyMedium, color: Colors.black87),
      ),
    );
  }
  ...
  static ThemeData buildDarkTheme(double factor) {
    ...
    return ThemeData(
      ...
      dialogTheme: DialogThemeData(
        ...
        contentTextStyle: TextStyle(fontSize: baseBodyMedium, color: colorScheme.onSurface),
      ),
    );
  }
}
